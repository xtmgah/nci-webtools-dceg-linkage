...
def calculate_assoc(file,region,pop,request,myargs):
	...
	if myargs.transcript==True:
		...
		export_svgs(assoc_plot, filename=file+"_assoc_plot.svg")
		# rug.output_backend = "svg"
		# export_svgs(rug, filename="rug.svg")
		gene_plot.output_backend = "svg"
		export_svgs(gene_plot, filename=file+"_gene_plot.svg")
		save(assoc_plot)
		save(gene_plot)
	...
	# Gene Plot (Collapsed)
		...
		export_svgs(gene_c_plot, filename=file+"_gene_c_plot.svg")
		save(assoc_plot)
		save(gene_c_plot)
		# print save(assoc_plot)
